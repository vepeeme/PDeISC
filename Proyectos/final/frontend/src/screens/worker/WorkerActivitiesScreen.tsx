// src/screens/worker/WorkerActivitiesScreen.tsx
...
const WorkerActivitiesScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
      ...
      <View style={styles.activityMeta}>
        ...
        {item.encargado_nombre && (
          <View style={styles.metaRow}>
            ...
            <Text style={styles.metaText}>{item.encargado_nombre}</Text>
          </View>
        )}
      </View>
      ...
      {item.fecha_fin_estimada && (
        <View style={styles.dateContainer}>
          ...
          <Text style={styles.dateText}>
            Vence: {new Date(item.fecha_fin_estimada).toLocaleDateString('es-ES')}
          </Text>
        </View>
      )}
    </TouchableOpacity>
...
export default WorkerActivitiesScreen;