// src/screens/auth/RegisterSupervisorScreen.tsx
...
const RegisterSupervisorScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert(
        '¡Solicitud Enviada!',
        result.mensaje || 'Tu solicitud está pendiente de aprobación por el administrador.',
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Registro Encargado</Text>
          <Text style={styles.subtitle}>Tu solicitud será revisada por un administrador</Text>
        </View>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Una vez registrado, deberás esperar la aprobación del administrador para acceder.
          </Text>
        </View>
